...
class ExperimentPath:
    ...
    def load(self, compress=False) -> object:
        if compress:
            ...
            with open(self._path + '.pkl', 'rb') as f:
                return pickle.load(f)
...
if __name__ == '__main__':
    # demo
    exp = ExperimentPath('exp/regular/asterix/sac/1234')
    exp['timestampti[,]menowtmsg'].csv_writerow([1, 2, 3])
    # exp['bcd']['x'].csv_writerow([1, 2, 3, 4])
